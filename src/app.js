...
const FS_SESSION_SECRT = COLE_LOCAL ? "C:/Users/ColeNelson/Desktop/cs571-s23/hws/apis/hw6-api/secret-generation/session-secret.secret" : "/secrets/session-secret.secret";
const FS_INIT_SQL = COLE_LOCAL ? "C:/Users/ColeNelson/Desktop/cs571-s23/hws/apis/hw6-api/includes/init.sql" : "/secrets/init.sql";
const FS_XID_ASSOCIATIONS = COLE_LOCAL ? "C:/Users/ColeNelson/Desktop/cs571-s23/hws/apis/hw6-api/secret-generation/ref-codes.secret" : "/secrets/ref-codes.secret";
...
function authenticateToken(req, res, next) {
    const token = req.cookies['badgerchat_auth']
...
app.use(function (req, res, next) {
    ...
    res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, Authorization, X-CS571-ID");
